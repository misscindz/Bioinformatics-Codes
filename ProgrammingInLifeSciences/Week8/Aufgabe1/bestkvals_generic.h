...
/* Return new <BestKVals> object. It will use <compare> to compare the elements to
...
/* tests if <invalue> is among the best and, if it is, inserts it.
   Uses memcpy to store what is in invalue. Invalue therefore can NOT
   contain pointers to non const elements! This would require a deep copy
   function! */
